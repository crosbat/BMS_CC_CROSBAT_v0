 ...
 *    | @ref sf_absoluteTime_setTimeBase()        | @copybrief sf_absoluteTime_setTimeBase()        |
...
/*============================================================================*/
/**
 * \brief Set absolute time time-base (start point). It shall be greater than
 *        beacon period.
 *
 * \param timestamp    The time base in seconds
 *
