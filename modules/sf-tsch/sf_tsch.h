 ...
 *    | @ref sf_tsch_setPanId()                   | @copybrief sf_tsch_setPanId()                   |
 *    | @ref sf_tsch_getPanId()                   | @copybrief sf_tsch_getPanId()                   |
 *    | @ref sf_tsch_addDataSlots()               | @copybrief sf_tsch_addDataSlots()               |
 *    | @ref sf_tsch_deleteDataSlots()            | @copybrief sf_tsch_deleteDataSlots()            |
...
/*============================================================================*/
/**
 * \brief Set network ID into the stack.
 *
 * \return @ref E_SF_RETURN_t
 */
/*============================================================================*/
E_SF_RETURN_t sf_tsch_setPanId(uint16_t panId);

/*============================================================================*/
/**
 * \brief Fetch pan ID value from the stack.
 *
 * \return pan ID
 */
/*============================================================================*/
uint16_t sf_tsch_getPanId(void);

/*============================================================================*/
/**
 * \brief Add data time-slots of the given sensor to the schedule.
...
/*============================================================================*/
/**
 * \brief Delete data time-slots of the given sensor from the schedule.
 *        This slots are used for regular communication.
 *
 * \param pAddr    Pointer to sensor link address. This should be the assigned
 *                 address by the gateway after successful manual join.
 ...
 */
/*============================================================================*/
E_SF_RETURN_t sf_tsch_deleteDataSlots(const linkaddr_t* pAddr);
