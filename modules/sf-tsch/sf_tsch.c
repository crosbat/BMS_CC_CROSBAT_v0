...
E_SF_RETURN_t sf_tsch_addDataSlots(const linkaddr_t* pAddr)
{
  ...
  /* Add data slots. */
  if(!sf_tsch_schedule_add_data_slots(pAddr, E_SF_TSCH_SCHEDULE_DATA_SLOTS_ALL))
  {
    return E_SF_SUCCESS;
  }
...
E_SF_RETURN_t sf_tsch_deleteDataSlots(const linkaddr_t* pAddr)
{
  ...
  /* Delete data slots. */
  if(!sf_tsch_schedule_delete_data_slots(pAddr, E_SF_TSCH_SCHEDULE_DATA_SLOTS_ALL))
  {
    return E_SF_SUCCESS;
  }
